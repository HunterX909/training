...
//		str1.forEach(System.out::print); //forEach is a terminal operation
...
//		numbers.stream().distinct().sorted().forEach(System.out::println); // sorted is intermedaite
		
//		System.out.println(numbers.stream().reduce(0, (n, m) -> n+m)); //reduce is terminal operation
//		System.out.println(numbers.stream().reduce(0, Integer::sum)); //reduce is terminal operation
//		System.out.println(numbers.stream().reduce(0, FirstStreamDemo::add)); //reduce is terminal operation
...
//		IntStream istr2 = IntStream.of(5,6,9,6,7,4);
